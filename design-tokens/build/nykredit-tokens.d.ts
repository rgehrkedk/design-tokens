/**
 * Autogenererede TypeScript typer for nykredit tokens
 * Genereret 2025-02-25T20:23:06.576Z
 */
...
export interface NykreditTokens {
  _meta: TokenMetadata;
  globals: TokenTree;
  brand: TokenTree;
  theme: {
...
declare module '*/nykredit-tokens.json' {
  const value: NykreditTokens;
...
export class TokenResolver {
  private tokens: NykreditTokens;
  private currentTheme: ThemeMode;
  
  constructor(tokens: NykreditTokens, defaultTheme: ThemeMode = 'light') {
    this.tokens = tokens;
